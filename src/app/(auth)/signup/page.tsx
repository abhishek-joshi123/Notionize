  ...
  return (
    <Form {...form}>
      <form
        ...
        <Link
          href="/" className=" w-full flex justify-left items-center">
        ...
        <span className="self-container">Already have an account?{' '}<Link href="/login" className="text-primary">Login</Link></span>
        {(confirmation || codeExchangeError) && (
          <>
